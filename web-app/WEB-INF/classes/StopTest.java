...
public class StopTest extends HttpServlet{
	...
	throws ServletException,IOException{
		...
		try{
			...
			out.println("<tr>");
        	out.println("<td width='100%' height='30'><p align='center'><font face='Verdana' color='#8000FF'><strong><small>This test has been stopped <br>The test takers will no longer be able to appear for this test.</small></strong></font></td>");
        	out.println("</tr>");	
        	out.println("<tr>");
	...
	public String getServletInfo(){
		return "Servlet to stop an active test";
	}	
}