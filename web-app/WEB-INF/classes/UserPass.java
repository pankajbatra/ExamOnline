...
public class UserPass extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException{
		...
		out.println("<tr>");
		out.println("<td width='100%' bgcolor='#F0F0FF' height='230' valign='top' align='center'><form method='POST' action='/servlet/UserChngPass'><br><br>");
		...
		out.println("<td width='50%' height='30' valign='middle' align='left'>&nbsp; <input type='password' name='passwd' style='border: 1px solid rgb(0,0,128)' size='20'></td>");
		out.println("</tr>");
		out.println("<tr align='center'>");
    ...
    public String getServletInfo(){
		return "Servlet for Changing User Password";
	}
}		
