...
public class EditQuesData extends HttpServlet{
	...
	throws ServletException,IOException{
		...
		if(session==null||ad_user==null||accessed.before(time_comp)){
			...
			out.println("</head>");
			out.println("<body>"); */
			RequestDispatcher dispatcher = req.getRequestDispatcher("/servlet/ViewQuestion?table_name="+table_name+"&min="+tmin+"&flag=1");
